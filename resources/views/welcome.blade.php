    ...
    <div class="mt-8 overflow-hidden sm:rounded-lg">
        <div class="hero-header">
            <div class="hero-content">
                <h1>Encuentra tu paz interior con la ayuda de nuestra página web de meditación.</h1>
        ...
        <section id="features" class="features-section">
            <div class="features-header">
                <h2 style="color: #714c4c">Características principales</h2>
            </div>
        ...
        <footer id="footer" class="footer-section">
            <p>&copy; 2024 Jhana. Todos los derechos reservados.</p>
        </footer>
